class Level extends Phaser.Scene {
    ...
    preload () {
        this.load.multiatlas('sprites', 'assets/sprites.json', '.');
...
//        this.load.audio('death', 'assets/audio/death.mp3');
    ...
    create () {
        ...
        console.log(shapes.ob1);
        this.matter.add.sprite(800-83, -939,'sprites','ob1',{shape: shapes.ob1});

        this.matter.add.sprite(800-152, -1850,'sprites','ob2',{shape: shapes.ob2});

        this.matter.add.sprite(135, -1899, 'sprites','ob3',{shape: shapes.ob3});
        this.matter.add.sprite(800-80, -2430, 'sprites','ob4',{shape: shapes.ob4});
        this.matter.add.sprite(80, -2430, 'sprites','ob5',{shape: shapes.ob5});
        this.matter.add.sprite(400, -2871,'sprites','ob6',{shape: shapes.ob6});
        this.matter.add.sprite(800-250, -3890, 'sprites','ob7',{shape: shapes.ob7});
        this.matter.add.sprite(106, -3496, 'sprites','ob8',{shape: shapes.ob8});
        this.matter.add.sprite(147, -4646,'sprites','ob9',{shape: shapes.ob9});
        this.matter.add.sprite(147, -5664, 'sprites','ob10a',{shape: shapes.ob10a});
        this.matter.add.sprite(111, -6180,'sprites','ob10b',{shape: shapes.ob10b});
        this.matter.add.sprite(800-143, -5245,'sprites','ob11',{shape: shapes.ob11});
        this.matter.add.sprite(800-211, -6353, 'sprites','ob12',{shape: shapes.ob12});
        this.matter.add.sprite(147, -7195,'sprites', 'ob10a',{shape: shapes.ob10a});
        this.matter.add.sprite(800-152, -7566, 'sprites','ob2',{shape: shapes.ob2});
        this.matter.add.sprite(400, -8271, 'sprites','ob6',{shape: shapes.ob6});
