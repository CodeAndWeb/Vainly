...
//        this.load.audio('death', 'assets/audio/death.mp3');
    ...
    create () {
        ...
        player = this.addSprite(400, 1000, 'sprites','arrowStraight.png',{shape: shapes.arrowStraight});
        ...
        this.input.on('pointerdown', function (pointer) {
            player.setTexture('sprites','arrowLeft.png',{shape: shapes.arrowLeft});
        ...
        this.input.on('pointerup', function () {
            player.setTexture('sprites','arrowRight.png',{shape: shapes.arrowRight});
            player.setVelocityX(13);
            player.boundsMargin = 0;
            player.setInteractive();
        });
